...
from model.components.basic import autopad, Bottleneck, Res, ResX
from model.components.csp_net import BottleneckCSPA, BottleneckCSPB, BottleneckCSPC, ResCSPA, ResCSPB, ResCSPC, \
